	pcihellocore u0 (
		...
		.ledgreen_external_connection_export    (<connected-to-ledgreen_external_connection_export>),    // ledgreen_external_connection.export
		.ledred_external_connection_export      (<connected-to-ledred_external_connection_export>),      //   ledred_external_connection.export
		...
		.switchs_external_connection_export     (<connected-to-switchs_external_connection_export>)      //  switchs_external_connection.export
	);
